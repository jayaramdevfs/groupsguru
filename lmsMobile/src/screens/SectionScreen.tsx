...
const SectionScreen = () => {
  ...
  const renderSection = ({ item }: { item: Section }) => (
    <TouchableOpacity
      ...
      onPress={() => {
        Alert.alert(
          language === "en" ? "Coming Soon" : "TE Coming Soon",
          language === "en"
            ? "Topic drill-down will be added in Sprint 5."
            : "TE Topic drill-down will be added in Sprint 5."
        );
      }}
    >
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.badge}>
            <Text style={styles.badgeText}>
              {language === "en" ? "Topics (Sprint 5)" : "TE Topics (Sprint 5)"}
            </Text>
          </View>
        </View>
      </View>
