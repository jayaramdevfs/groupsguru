      ...
      <div className="max-w-[1000px] mx-auto py-12 px-6">
        ...
        <header className="mb-12 flex flex-col sm:flex-row sm:items-end justify-between gap-6 border-b border-[#3A3A3A] pb-8">
          ...
          <div className="flex items-center gap-4">
            <Link
              href={`/student/content?entityType=TOPIC&entityId=${topicId}`}
              className="px-4 py-2 rounded bg-[#D97706]/10 text-[#D97706] border border-[#D97706]/30 hover:bg-[#D97706]/20 transition-colors text-[10px] font-mono font-bold uppercase tracking-[0.2em] flex items-center gap-2"
            >
